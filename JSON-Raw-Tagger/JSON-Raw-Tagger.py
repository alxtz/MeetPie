...
# some filters
frontEnd = ['html','css','javascript','vue','react','front-end','front end','sass','suss','bootstrap','ruby','網頁製作','SEO','fullstack','全端','webapp']
...
def tagRawJson(inputPath, outputPath):
    jsonFileOpen = open(inputPath,'r')
    ...
    with io.open(outputPath, 'w', encoding='utf8') as json_file:
